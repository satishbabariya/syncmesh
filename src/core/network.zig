...
pub const NetworkLayer = struct {
    ...
    pub fn init(allocator: Allocator, io: *IO, config: *const Config) !NetworkLayer {
        ...
        var connections = ConnectionPool.init(allocator, 100); // Max 100 connections
        
        // Initialize message queue
        var message_queue = try MessageQueue.init(allocator, 1024);
    ...
    pub fn sendSyncOperation(self: *NetworkLayer, operation: SyncOperation) !void {
        _ = self;
